...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%> 
    ...
    %>
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F7BE81;">
        	...
        	<strong>
          	...
          	<button class="navbar-toggler" data-bs-toggle="collapse" type="button" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
		  		<div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/home.do"><strong>Home</strong></a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><strong>Mealkit</strong></a>
            	...
            	<ul class="navbar-nav justify-content-end">
               	<c:choose>
					<c:when test="${ empty id}">
				 		<a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/users/signup_form.do"><strong>Sign up</strong></a>
                  		<a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/users/loginform.do"><strong>Login</strong></a>
					</c:when>
				 	<c:otherwise>
					  	<span class="navbar-text me-2">
	                    	<a href="${pageContext.request.contextPath}/users/private/info.do">${id }</a>
		                </span>
		                <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/users/logout.do"><strong>Logout</strong></a>
				 	</c:otherwise>
            	</c:choose>
            	         <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="${pageContext.request.contextPath}/users/private/info.do" role="button" data-bs-toggle="dropdown" aria-expanded="false"><strong>Mypage</strong></a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
